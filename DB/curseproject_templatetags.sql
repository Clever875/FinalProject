...
--
-- Dumping data for table `templatetags`
--

LOCK TABLES `templatetags` WRITE;
/*!40000 ALTER TABLE `templatetags` DISABLE KEYS */;
/*!40000 ALTER TABLE `templatetags` ENABLE KEYS */;
UNLOCK TABLES;
